...
const HomePricing = () => {
    ...
    return (
        <div>
                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="flex flex-wrap items-stretch -mx-4">
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/4 lg:mb-0 ">
                            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900 bg-[#E68C86]">
                                <div className="space-y-2">
                                    ...
                                    <span className="text-6xl font-bold">Offer</span>
                                </div><p>special offer my new food zone</p>
                        ...
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-400 dark:text-gray-900 bg-[#E68C86]">
                                <div className="space-y-2">
                                    <h4 className="text-2xl font-bold">Monthly </h4>
                                    <span className="text-6xl font-bold">Offer
                                        <span className="text-sm tracking-wide">%25 discount</span>
                                    </span>
                                </div>
                                <p className="leading-relaxed">Every month my store get 25% discount </p>
                        ...
                        <div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900 bg-[#E68C86]">
                                <div className="space-y-2">
                                    <h4 className="text-2xl font-bold">Yearly </h4>
                                    <span className="text-6xl font-bold">Offer
                                        <span className="text-sm tracking-wide">50% discount</span>
                                    </span>
                                </div>
                                <p className="leading-relaxed dark:text-gray-400">Yearly offer is big offer </p>
            ...
            <section className="py-6 dark:bg-gray-800 dark:text-gray-50 bg-[#E1ECEA] mt-5">
                <div className="container mx-auto flex flex-col justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row">
                    <div className="flex flex-col space-y-4 text-center lg:text-left">
                        <h1 className="text-5xl font-bold leading-none">Stay your best food restaurant</h1>
                        <p className="text-lg">please you visit our big restaurant and best best offer and you get big discount our restaurant always give fresh and good food and price is very low so visit my pato food restaurant</p>
                    </div>
                    <div className="flex flex-row items-center self-center justify-center flex-shrink-0 shadow-md lg:justify-end">
                        <div className="flex flex-row">
                            <input type="text" placeholder="example@email.com" className="w-3/5 p-3 rounded-l-lg sm:w-2/3" />
                            <button type="button" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 dark:bg-violet-400 dark:text-gray-900 bg-zinc-500">Subscribe</button>
                        </div>
                    </div>
                </div>
            </section>
